...
var INIT_SETTINGS = {theme:"studio",name:"",school:"",specialism:"General Science",density:"comfortable",defaultView:"focus",workStart:"07:30",workEnd:"18:00",weekendProtection:true,pomoWork:25,pomoBreak:5,defaultPriority:"medium",defaultCategory:"teaching",defaultMins:30,termName:"Summer Term 2026",halfTerm:"2026-05-25",examStart:"2026-05-11",examEnd:"2026-06-26"};
...
var INIT_CLUBS = [
  {id:"cl1",memberId:"dad",name:"Rugby Coaching",day:"Wed",time:"19:00",location:"St Ives RFC",costPerMonth:0,notes:""},
  {id:"cl2",memberId:"c1",name:"Add activity",day:"Sat",time:"10:00",location:"",costPerMonth:0,notes:""},
  {id:"cl3",memberId:"c2",name:"Add activity",day:"Tue",time:"17:30",location:"",costPerMonth:0,notes:""},
];
...
export default function App(){
  ...
  var stNewClub = useState({memberId:"dad",name:"",day:"Mon",time:"17:00",location:"",costPerMonth:0,notes:""}); var newClub=stNewClub[0], setNewClub=stNewClub[1];
  ...
  function buildCalEvents(dateKey){
    ...
    tasks.filter(function(t){return t.dueDate===dateKey&&!t.done;}).forEach(function(task){
      var cat=CATS[task.category];
    ...
    clubs.filter(function(c){return c.day===dayKey;}).forEach(function(c){
  ...
  function addClub(){
    ...
    setClubs(function(prev){return prev.concat([Object.assign({},newClub,{id:"cl"+Date.now()})]);});
              ...
              return(
                <div key={c.id} style={card({marginBottom:8,borderLeft:"3px solid "+mem.color})}>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:10}}>
                    ...
                    <button onClick={function(){removeClub(c.id);}} style={{background:"none",border:"1px solid "+th.red+"44",borderRadius:5,padding:"3px 8px",fontSize:10,color:th.red,cursor:"pointer",fontFamily:"inherit",flexShrink:0}}>Remove</button>
                  </div>
                </div>
              );
            })}
          ...
          <div className="fu">
            ...
            {mealTab==="plan"&&(
              <div>
                ...
                {/* Favourites */}
                <div style={card()}>
                  <div style={{fontFamily:"'Syne',sans-serif",fontSize:10,fontWeight:700,color:th.textMuted,letterSpacing:"0.1em",textTransform:"uppercase",marginBottom:10}}>Family favourites - tap to add to a day</div>
                  <div style={{display:"flex",flexWrap:"wrap",gap:6}}>
                ...
                family.map(function(m){
                  ...
                  return React.createElement("div",{key:m.id,style:{display:"flex",alignItems:"center",gap:10,padding:"10px 0",borderTop:"1px solid "+th.border}},
                    ...
                    React.createElement("div",{style:{flex:1}},
                      React.createElement("label",{style:{fontSize:10,color:th.textMuted,display:"block",marginBottom:4}},m.role),
                      React.createElement("input",{type:"text",value:m.name,onChange:function(e){updateFamilyName(m.id,e.target.value);},placeholder:"Enter name",style:inpSt({fontSize:12,padding:"6px 10px"})})
                    ),
          ...
          <div className="fu">
            ...
            <div style={{paddingTop:12}}>
              ...
              <div style={{display:"flex",gap:6,marginBottom:10}}>
                <input type="text" value={settings.gcalUrl||""} onChange={function(e){var v=e.target.value;setSt(function(s){return Object.assign({},s,{gcalUrl:v});});}} placeholder="https://calendar.google.com/calendar/ical/..." style={inpSt({flex:1,fontSize:11})}/>
